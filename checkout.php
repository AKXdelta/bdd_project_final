...
<section class="ftco-section">
  <div class="container">
    <div class="row">
      ...
      <!-- ================= FORM START ================= -->
      <form action="billing.php" method="POST" class="col-xl-8 ftco-animate billing-form ftco-bg-dark p-3 p-md-5">
        ...
        <!-- ================= CART TOTAL ================= -->
        <div class="cart-detail cart-total ftco-bg-dark p-3 p-md-4 mt-4">
        ...
        <!-- ================= PAYMENT ================= -->
        <div class="cart-detail ftco-bg-dark p-3 p-md-4 mt-4">
        ...
        <!-- ================= SUBMIT ================= -->
        <button type="submit" class="btn btn-primary py-3 px-4 mt-4">
          Place an order
        </button>
